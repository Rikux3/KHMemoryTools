...
namespace KHMemory
{
    ...
    {
        public static Dictionary<int, string> dictEnemies = new Dictionary<int, string>(){
            {1, " Böllerwampe / Fat Bandit (Gegner! / Enemy!)"},
            {2, " Schizo-Spuk / Trick Ghost (Gegner! / Enemy!)"},
            {3, " Schoßhund / Rabid Dog (Gegner! / Enemy!)"},
            {4, " Flederhaken / Hook Bat (Gegner! / Enemy!)"},
            {5, " Magus Magnus / Bookmaster (Gegner! / Enemy!)"},
            {6, " Blauer Baron / Aeroplane (Gegner! / Enemy!)"},
            {7, " Bombenmolch / Minute Bomb (Gegner! / Enemy!)"},
            {8, " Hammerlakai / Hammer Frame (Gegner! / Enemy!)"},
            {9, " Zentaurier / Assault Rider (Gegner! / Enemy!)"},
            {10, " Schreck-Geck / Nightwalker (Gegner! / Enemy!)"},
            {11, " Wahrsagerin / Fortuneteller (Gegner! / Enemy!)"},
            {12, " Mondräuber / Luna Knight (Gegner! / Enemy!)"},
            {13, " Retro-Raser / Hot Rod (Gegner! / Enemy!)"},
            {14, " Böllerbolzen / Cannon Gun (Gegner! / Enemy!)"},
            {15, " Schädelbulle / Living Bone (ohne Schamane / without Shaman) (Gegner! / Enemy!)"},
            {16, " Transbot / Devastator (Gegner! / Enemy!)"},
            {17, " Lanzensoldat / Lance Soldier (Gegner! / Enemy!)"},
            {18, " Drilling / Mole Driller (Gegner! / Enemy!)"},
            {19, " Shamane / Shaman (Gegner! / Enemy!)"},
            {20, " Flugboxer / Aerial Knocker (Gegner! / Enemy!)"},
            {71, " Silberling / Silver Rock (Gegner! / Enemy!)"},
            {72, " Saphirling / Emerald Blues (Gegner! / Enemy!)"},
            {73, " Purpurling / Crimson Jazz (Gegner! / Enemy!)"},
            {74, " Luftpirat / Air Pirate (Gegner! / Enemy!)"},
            //{75, " Freudenspender / Bulky Vendor (Gegner! / Enemy!)"},
            {76, " Kugelfeuer / Fiery Globe (Gegner! / Enemy!)"},
            {77, " Würfeleis / Icy Cube (Gegner! / Enemy!)"},
            {118, " Gigg-Schack / Wight Knight (Gegner! / Enemy!)"},
            {119, " Gigg-Schack / Wight Knight (Halloween Town) (Gegner! / Enemy!)"},
            {120, " Schattenschalk / Neoshadow (Gegner! / Enemy!)"},
            {121, " Tetrabot / Magnum Loader (Gegner! / Enemy!)"},
            {122, " Morgenstern / Morningstar (Gegner! / Enemy!)"},
            {123, " Tornado-Tänzer / Tornado Step (Gegner! / Enemy!)"},
            {124, " Crescendo (Gegner! / Enemy!)"},
            {125, " Schauderplanze / Creeper Plant (Gegner! / Enemy!)"},
            //{220, " Schatten-Infanterist / Armored Knight (Gegner! / Enemy!) (Dummy)"},
            //{221, " Wachroboter (Gegner! / Enemy!) (Dummy)"},
            {301, " Klappersoldat / Soldier (Gegner! / Enemy!)"},
            {302, " Schattenlurch / Shadow (Gegner! / Enemy!)"},
            {303, " Adowampe / Large Body (Gegner! / Enemy!)"},
            {304, " Propellerdrohne / Rapid Thruster  (Gegner! / Enemy!)"},
            {305, " Schatten-Infanterist / Armored Knight (Gegner! / Enemy!)"},
            {306, " Wachroboter / Surveillance Robot (Gegner! / Enemy!)"},
            {308, " Dragoner / Dragoon (Gegner! / Enemy!)"},
            {309, " Meuchler / Assassin (Gegner! / Enemy!)"},
            {310, " Samurai (Gegner! / Enemy!)"},
            {311, " Scharfschütze / Sniper (Gegner! / Enemy!)"},
            {312, " Tänzer / Dancer (Gegner! / Enemy!)"},
            {313, " Berserker (Gegner! / Enemy!)"},
            {314, " Spieler / Gambler (Gegner! / Enemy!)"},
            {315, " Beschwörer / Sorcerer (Gegner! / Enemy!)"},
            {316, " Beschwörer v2 / Sorcerer v2 (Gegner! / Enemy!)"},
            {317, " Kriecher / Creeper (Gegner! / Enemy!)"},
            {318, " Dämmerling / Dusk (Gegner! / Enemy!)"},
            {344, " Funke? / Sparkle? (Gegner! / Enemy!)"},
            {345, " Weißes Feuer / White Fire (Gegner! / Enemy!)"},
            {367, " Gargoyle-Ritter / Gargoyle Knight (Gegner! / Enemy!)"},
            {368, " Gargoyle-Krieger / Gargoyle Warrior (Gegner! / Enemy!)"},
            {1107, " Untoter Pirat A / Undead Pirate A (Gegner! / Enemy!)"},
            {1108, " Untoter Pirat B / Undead Pirate B (Gegner! / Enemy!)"},
            {1109, " Untoter Pirat C / Undead Pirate C (Gegner! / Enemy!)"},
            {1114, " Telebot / Strafer (Gegner! / Enemy!)"},
            {1220, " Schattenlurch / Shadow (Halloween Town) (Gegner! / Enemy!)"},
            {1365, " Schattenlurch / Shadow (Gegner! / Enemy!)"},
            //{1366, " Wachroboter / Surveillance Robot (1000 Herzlosen Kampf! / 1000 Heartless Battle!) (Gegner! / Enemy!)"},
            {1367, " Propellerdrohnen in Massen / Crowd of Rapid Thrusters (Gegner! / Enemy!)"},
            {1368, " Propellerdrohne / Rapid Thruster (Gegner! / Enemy!)"},
            {1468, " Schatten-Infanterist / Armored Knight (Gegner! / Enemy!)"},
            {1469, " Wachroboter / Surveillance Robot (Gegner! / Enemy!)"},
            {1573, " Bienen / Bees (Gegner! / Enemy!)"},
            {1575, " Bolzenturm / Bolt Tower (Gegner! / Enemy!)"},
            {1576, " Bolzenturm / Bolt Tower (Gegner! / Enemy!)"},
            {1610, " weiße Flamme / white Flame (Gegner! / Enemy!)"},
            {1670, " Kugelfeuer / Fiery Globe (Gegner! / Enemy!)"},
            {1671, " Würfeleis / Icy Cube (Gegner! / Enemy!)"},
            {1673, " Kugelfeuer / Fiery Globe (Gegner! / Enemy!)"},
            {1674, " Würfeleis / Icy Cube (Gegner! / Enemy!)"},
            {1675, " Tetrabot (Weiß) / Magnum Loader (White) (Gegner! / Enemy!)"},
            {1717, " Tetrabot (Blau) / Magnum Loader (Blue) (Gegner! / Enemy!)"},
            {1718, " Tetrabot (Gelb) / Magnum Loader (Yellow) (Gegner! / Enemy!)"},
            {1719, " Tetrabot (Green) / Magnum Loader (Green) (Gegner! / Enemy!)"},
            {1727, " Berserker-Schwert / Berserker Sword (Objekt / Object) (Gegner! / Enemy!)"},
            {1760, " Wahrsagerin / Fortuneteller (Gegner! / Enemy!)"},
            {1774, " Gruselkürbis / Graveyard (Gegner! / Enemy!)"},
            {1775, " Gruselkürbis / Graveyard (Halloween Town) (Gegner! / Enemy!)"},
            {1776, " Gruselkürbis / Graveyard (Christmas Town) (Gegner! / Enemy!)"},
            {1777, " Gruselkürbis / Graveyard (Christmas Town, Halloween Town) (Gegner! / Enemy!)"},
            {1821, " Bolzenturm / Bolt Tower + Propellerdrohne / Rapid Thruster (in Massen / in Mass) (Gegner! / Enemy!)"},
            {1827, " Schizo-Spuk / Trick Ghost (Halloween Town) (Gegner! / Enemy!)"},
            {1828, " Blauer Baron / Aeroplane (Fluss der Nostalgie / Timeless River) (Gegner! / Enemy!)"},
            {1829, " Bombenmoloch / Minute Bomb (Fluss der Nostalgie / Timeless River) (Gegner! / Enemy!)"},
            {1830, " Hammerlakai / Hammer Frame (Fluss der Nostalgie / Timeless River) (Gegner! / Enemy!)"},
            {1831, " Retro-Raser / Hot Rod (Fluss der Nostalgie / Timeless River) (Gegner! / Enemy!)"},
            {1832, " Böllerbolzen / Cannon Gun (Space Paranoids) (Gegner! / Enemy!)"},
            {1833, " Drilling / Mole Driller (Halloween Town) (Gegner! / Enemy!)"},
            {1834, " Saphirling / Emerald Blues (Halloween Town) (Gegner! / Enemy!)"},
            {1835, " Magus Magnus / Bookmaster (Space Paranoids) (Gegner! / Enemy!)"},
            {1836, " Schattenschalk / Neoshadow (Halloween Town) (Gegner! / Enemy!)"},
            {1837, " Schauderplanze / Creeper Plant (Halloween Town) (Gegner! / Enemy!)"},
            {1838, " Klappersoldat / Soldier (Halloween Town) (Gegner! / Enemy!)"},
            {1839, " Klappersoldat / Soldier (Space Paranoids) (Gegner! / Enemy!)"},
            {1840, " Schattenlurch / Shadow (Fluss der Nostalgie / Timeless River) (Gegner! / Enemy!)"},
            {1841, " Schattenlurch / Shadow (Halloween Town) (Gegner! / Enemy!)"},
            {1842, " Schattenlurch / Shadow (Fluss der Nostalgie / Timeless River) (Gegner! / Enemy!)"},
            {1843, " Propellerdrohne / Rapid Thruster (Fluss der Nostalgie / Timeless River) (Gegner! / Enemy!)"},
            {1845, " Schatten-Infanterist / Armored Knight (Halloween Town) (Gegner! / Enemy!)"},
            {1847, " Wachroboter / Surveillance Robot (Space Paranoids) (Gegner! / Enemy!)"},
            {1849, " Klappersoldat / Soldier (Fluss der Nostalgie / Timeless River) (Gegner! / Enemy!)"},
            {1852, " Saphirling / Emerald Blues (Space Paranoids) (Gegner! / Enemy!)"},
            {1875, " Telebot / Strafer (Gegner! / Enemy!)"},
            {1887, " Flederhaken / Hookbat (Agrabah) (Gegner! / Enemy!)"},
            {1888, " Purpurling / Crimson Jazz (Agrabah) (Gegner! / Enemy!)"},
            {1889, " Propellerdrohne / Rapid Thruster (Agrabah) (Gegner! / Enemy!)"},
            {2025, " Adowampe / Large Body (Fluss der Nostalgie / Timeless River) (Gegner! / Enemy!)"},
            {2076, " Gruselkürbis / Graveyard (Gegner! / Enemy!)"},
            {2099, " Scars Geist / Scar’s Ghost (Gegner! / Enemy!)"},
            {2138, " Bienen / Bees (Gegner! / Enemy!)"},
            {2139, " Bienen / Bees (Gegner! / Enemy!)"},
            {2202, " Niemand vom Endkampf v1 / Nobody from Final Battle v1  (Gegner! / Enemy!)"},
            {2238, " Bolzenturm / Bolt Tower (Das Land der Drachen / Land of Dragons) (Gegner! / Enemy!)"},
            {2239, " Bolzenturm / Bolt Tower (Das Land der Drachen / Land of Dragons) (Gegner! / Enemy!)"},
            {2285, " Niemand vom Endkampf v2 / Nobody from Final Battle v2  (Gegner! / Enemy!)"},
            {2288, " Bolzenturm / Bolt Tower (Schloss Disney / Disney Castle) (Gegner! / Enemy!)"},
            //{2342, " Mushroom No.1 (Gegner! / Enemy!)"},
            //{2343, " Mushroom No.2 (Gegner! / Enemy!)"},
            //{2344, " Mushroom No.3 (Gegner! / Enemy!)"},
            //{2345, " Mushroom No.4 (Gegner! / Enemy!)"},
            //{2346, " Mushroom No.5 (Gegner! / Enemy!)"},
            //{2347, " Mushroom No.6 (Gegner! / Enemy!)"},
            //{2348, " Mushroom No.7 (Gegner! / Enemy!)"},
            //{2349, " Mushroom No.8 (Gegner! / Enemy!)"},
            //{2350, " Mushroom No.9 (Gegner! / Enemy!)"},
            //{2351, " Mushroom No.10 (Gegner! / Enemy!)"},
            //{2352, " Mushroom No.11 (Gegner! / Enemy!)"},
            //{2353, " Mushroom No.12 (Gegner! / Enemy!)"},
            //{2354, " Mushroom No.13 (Gegner! / Enemy!)"},
            {2403, " Magic Phantom (Gegner! / Enemy!)"},
            {2404, " Perplex (Gegner! / Enemy!)"},
            {2405, " Iron Hammer (Gegner! / Enemy!)"},
            {2406, " Mad Bumper (Gegner! / Enemy!)"},
            {2407, " Silent Launcher (Gegner! / Enemy!)"},
            {2408, " Reckless (Gegner! / Enemy!)"},
            {2409, " Lance Warrior (Gegner! / Enemy!)"},
            {2410, " Aerial Champ (Gegner! / Enemy!)"},
            {2411, " Necromancer (Gegner! / Enemy!)"},
            {2412, " Spring Metal (Gegner! / Enemy!)"},
            {2413, " Air Viking (Gegner! / Enemy!)"},
            {2414, " Rune Master (Gegner! / Enemy!)"},
            //{2509, " Freudenspender / Bulky Vendor (Halloween Town) (Gegner! / Enemy!)"},
            //{2539, " Dancing Mushroom (Gegner! / Enemy!)"}
        };

        public static Dictionary<int, string> dictBosses = new Dictionary<int, string>(){
            {21, "Shan-Yu (Boss!)"},
            {22, "Hayabusa (Shan-Yus Falke / Shan-Yu's Falcon) (Boss!)"},
            {81, "Axel (Twilight Town, 2. Kampf) (Boss!)"},
            {126, "Oogie Boogie (Boss!)"},
            {127, "Furcht / Lock (Boss!)"},
            {128, "Angst / Shock (Boss!)"},
            {129, "Schrecken / Barrel (Boss!)"},
            {307, "Twilight-Dorn / Twilight Thorn (Boss!)"},
            {348, "Dschafar / Jafar (Djinn) (Boss!)"},
            {349, "Hades (1. & 2. Kampf / Battle) (Boss!)"},
            {350, "Hades (3. & Paradox Hades Cup-Kampf / Battle) (Boss!)"},
            {351, "Zerberus / Cerberus (Boss!)"},
            {352, "Hydra (Boss!)"},
            {353, "Torwächter / Thresholder (Boss!)"},
            {354, "Dunkeltroll / Dark Thorn (Boss!)"},
            {355, "Kettenbalg / Shadow Stalker (Boss!)"},
            {357, "Sturmreiter / Storm Rider (Boss!)"},
            {358, "Illuminator (Boss!)"},
            {359, "Karlo / Pete (Fluss der Nostalgie / Timeless River) (Boss!)"},
            {644, "Kettenbalg Kronleuchter / Shadow Stalker Chandelier (Objekt / Object) (Boss!)"},
            {645, "Kettenbalg Säulen / Shadow Stalker Pillars (Objekt / Object) (Boss!)"},
            {665, "Shenzi (Boss!)"},
            {666, "Banzai (Boss!)"},
            {667, "Ed (Boss!)"},
            {668, "Scar (Boss!)"},
            {718, "Das Biest / The Beast (Boss!)"},
            {795, "Demyx (Arena des Olymps / Olympus Coliseum, 1. Battle) (Boss!)"},
            {862, "Sark (Boss!)"},
            {922, "Hydras Kopf / Hydra's Head (Boss!)"},
            {964, "Sark (Groß / Large) (Boss!)"},
            {987, "Karlo / Pete (Fluss der Nostalgie / Timeless River) (Boss?)"},
            {997, "Xaldin (Boss!)"},
            {1015, "Barbossa (Boss!)"},
            {1035, "Vulkanlord / Volcano Lord (Boss!)"},
            {1036, "Blizzardlord / Blizzard Lord  (Boss!)"},
            {1113, "Bodenbeben / Groundshaker (Boss!)"},
            {1184, "Demyx Wasserklon / Demyx's Water Clone (Boss!)"},
            {1208, "Das aggressive Programm /  The aggressive Program (Boss!)"},
            {1239, "Hayner (Boss!)"},
            {1486, "Gefängniswärter / Prison Keeper (Boss!)"},
            {1488, "Die Marionette / The Experiment (Boss!)"},
            {1528, "Luxord (Keine HP Leiste / No HP-Bar) (Boss!)"},
            {1535, "Luxords Karte / Luxord's Card (Boss!)"},
            {1543, "Sensenmeister / Grim Reaper (Boss!) (könnte abstürzen... / may crash...)"},
            {1570, "Xigbar (Boss!)"},
            {1578, "Vulkanlord / Volcano Lord (Boss!) (Freeze!)"},
            {1579, "Blizzardlord / Blizzard Lord (Boss!) (Freeze!)"},
            {1593, "Dschafars Wasserklon (unverwundbar) / Jafar's Water Clone (invincible) (Boss!)"},
            {1596, "Riku (Boss!)"},
            {1606, "Xemnas (1. Battle) (Boss!)"},
            {1607, "Karlo / Pete (Fluss der Nostalgie / Timeless River) (Boss!)"},
            {1656, "Cifer / Seifer (Boss!)"},
            {1723, "Karlo / Pete (Megara Battle) (Boss!)"},
            {1724, "Karlo / Pete (Hercules Battle) (Boss!)"},
            {1737, "Saïx (Boss!)"},
            {1762, "MCP (Boss!) (Dummy)"},
            {1778, "Sephiroth (Block-Pose / Guard Stance) (Boss!)"},
            {1786, "Saïx-Schwert / Saïx-Sword (Objekt / Object) (Boss!)"},
            {1808, "Die Marionette / The Experiment (Kopf / Head) (Boss!)"},
            {1809, "Die Marionette / The Experiment (linke / left Hand) (Boss!)"},
            {1810, "Die Marionette / The Experiment (rechte / right Hand) (Boss!)"},
            {1876, "Roxas' Shadow Doppelgaenger (Boss?)"},
            {2066, "Hades (Boss!)"},
            {2079, "Xemnas (Finale) / Final Xemnas (Boss!) (Nichts / Nothing)"},
            {2095, "Setzer (Boss!)"},
            {2119, "Shenzi (Boss!)"},
            {2140, "Xemnas (Rüstung / Armor) (Boss!)"},
            {2156, "Vivi (Boss!) (Spielabsturz nach dem Sieg / Game Crash after defeat)"},
            {2189, "Xemnas (Drache) / Xemnas (Dragon) (Boss!) (Freeze)"},
            {2229, "Axel (Twilight Town, 1. Battle) (Boss!)"},
            {2230, "Sephiroth (Boss!)"},
            {2256, "Vivi (Boss!) (Spielabsturz nach dem Sieg / Game Crash after defeat)"},
            {2277, "Barbossa (Dummy) (Freeze)"},
            {2294, "Demyx Wasserklon / Demyx's Water Clone (Boss!)"},
            {2295, "Demyx (Boss!) (Hollow Bastion, 2. Battle) (Boss!)"},
            {2296, "Squall / Leon (Boss!)"},
            {2297, "Cloud (Boss!)"},
            {2298, "Tifa (Boss!)"},
            {2299, "Yuffie (Boss!)"},
            {2339, "Marluxia (Absent Silhouette) (Boss!)"},
            {2355, "Vexen (Absent Silhouette) (Boss!)"},
            {2356, "Vexen's Anti-Sora (Boss!)"},
            {2357, "Lexaeus (Absent Silhouette) (Boss!)"},
            {2385, "Roxas (Boss!)"},
            {2402, "Larxene (Absent Silhouette) (Boss!)"},
            {2415, "Terra (Boss!)"},
            {2427, "Zexion (Absent Silhouette) (Boss!)"},
            {2429, "Zexion's Book (Objekt / Object) (Boss!)"},
            {2500, "Axel (Limit Cut) (Boss!)"},
            {2501, "Xigbar (Limit Cut) (Boss!)"},
            {2502, "Saïx (Limit Cut) (Boss!)"},
            {2504, "Luxord (Limit Cut) (Boss!)"},
            {2505, "Xemnas (Limit Cut, Memory's Contortion)  (Boss!)"},
            {2506, "Xemnas (Limit Cut, The World of Nothing?) (Boss!)"},
            {2507, "Xaldin (Limit Cut) (Boss!)"},
            {2508, "Demyx (Limit Cut) (Boss!)"},
            {2554, "Demyx Wasserklon / Demyx's Water Clone (Limit Cut) (Boss!)"}
        };


        public static int GetWorldIndex(int num)
        {
            for (int i = 0; i < Worlds.Length; i++)
            {
                int sub = Convert.ToInt32(Worlds[i].Split(new string[] { " - " }, StringSplitOptions.None)[0], 16);
                if (num == sub)
                    return i;
            }
            return 0;
        ...
        public static int GetRoomIndex(int worldIndex, int Num)
        {
            for (int i = 0; i < Rooms[worldIndex].Length; i++)
            {
                int sub = Convert.ToInt32(Rooms[worldIndex][i].Split(new string[] { " - " }, StringSplitOptions.None)[0], 16);
                if (Num == sub)
                    return i;
            }
            return 0;
        ...
        public static int GetEventIndex(int worldIndex, int roomIndex, int Num)
        {
            for (int i = 0; i < AllEvents[worldIndex][roomIndex].Length; i++)
            {
                int sub = Convert.ToInt32(AllEvents[worldIndex][roomIndex][i].Split(new string[] { " - " }, StringSplitOptions.None)[0], 16);
                if (Num == sub)
                    return i;
            }
            return 0;
        }
        public static string[] Worlds = new string[19]
        {
        ...
        {
            new string[2]{ "00 - The Dark Margin", "01 - Loop Demo" },
            new string[41]
            {
              "00 - The Empty Realm",
              "01 - Roxas's Room",
            ...
            new string[2]{ "00 - World Map", "01 - DUMMY" },
            new string[26]
            {
              "00 - Rampart",
              "01 - Harbor",
        ...
        public static string[][][] AllEvents = new string[19][][]
      {
         new string[2][]
          {
             new string[5]
